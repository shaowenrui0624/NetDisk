...
struct File_Info
{
    File_Info():fileid(0),filefd(0),pos(0),size(0)
    {
...
///////////////////////断点续传////////////////
////用于更新控件上传位置
#define _DEF_PACK_GET_UPLOAD_POS_RQ (_DEF_PROTOCOL_BASE + 26)
#define _DEF_PACK_GET_UPLOAD_POS_RS (_DEF_PROTOCOL_BASE + 27)
...
////////上传续传协议//////////
//////会询问服务器已经上传到哪里了，所以要有回复，服务器把已经到哪了返回给客户端
